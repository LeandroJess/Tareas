Funcion porcentajeBono <- bonoAñoDeAntiguedad(añosAntiguedad)
...
Funcion aporteNS <- aporteNcionalSolidario(sueldo)
...
Algoritmo BoletaPagoDocentesssss
	...
	Definir sueldo,añosAntiguedad,Egreso,ingresos Como Real
	...
	Definir gestionIngreso,salarioMinimoNacional,horasDiurnas,horasNocturnas,liquidoPagable Como Entero 
	Escribir "================================================="
	...
	Escribir "AFP: ", afp, "%"
	Escribir "Aporte Nacional Solidario: ", aporteNcionalSolidario(sueldo), " Bs."
